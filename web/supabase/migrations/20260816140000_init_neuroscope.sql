...
-- Paste this into the Supabase SQL Editor, or run via `supabase db query`.
-- Explicit GRANTs are required: new projects no longer expose public tables
-- to the Data API automatically (changelog 45329, 2026-04-28).
...
-- Data API surface: INSERT only. No SELECT / UPDATE / DELETE for the web client.
